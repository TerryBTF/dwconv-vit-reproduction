...
class Transformer(nn.Module):
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, Height, Width, dropout=0., use_dwconv=True):
        super().__init__()
...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool='cls', channels=3, dim_head=64, dropout=0., emb_dropout=0., use_dwconv=True, use_pe=True):
        super().__init__()
        ...
        self.transformer = Transformer(dim, depth, heads, dim_head, mlp_dim, Height, Width, dropout, use_dwconv=use_dwconv)
